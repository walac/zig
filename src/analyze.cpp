...
TypeTableEntry *get_promise_frame_type(CodeGen *g, TypeTableEntry *return_type) {
    ...
    TypeTableEntry *usize_ptr_type = get_pointer_to_type(g, g->builtin_types.entry_usize, false);
    const char *field_names[] = {
        AWAITER_HANDLE_FIELD_NAME,
        RESULT_FIELD_NAME,
        RESULT_PTR_FIELD_NAME,
        ERR_RET_ADDR_FIELD_NAME,
        ERR_RET_ADDR_PTR_FIELD_NAME,
    };
    ...
    uint32_t field_count = g->have_err_ret_tracing ? 5 : 3;
