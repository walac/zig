...
pub const Dir = struct {
    ...
    pub fn open(allocator: &Allocator, dir_path: []const u8) -> %Dir {
        const fd = switch (builtin.os) {
            ...
            Os.linux => try posixOpen(dir_path, posix.O_RDONLY|posix.O_DIRECTORY|posix.O_CLOEXEC, 0, allocator),
            Os.macosx, Os.ios => try posixOpen(dir_path, posix.O_RDONLY|posix.O_NONBLOCK|posix.O_DIRECTORY|posix.O_CLOEXEC, 0, allocator),
        };
